export const OrderTypeEnum = {
  ...
  BSC_SELLER_SALES_ORDER: 'BSC_SELLER_SALES_ORDER',
  BSC_SELLER_PURCHASE_ORDER: 'BSC_SELLER_PURCHASE_ORDER',
} as const;
...
export const OrderStatusEnum = {
  ...
  RESTOCK_PARTIAL: 'RESTOCK_PARTIAL',
  RESTOCK_CANCELLED: 'RESTOCK_CANCELLED',
  RETURNED: 'RETURNED',
} as const;
